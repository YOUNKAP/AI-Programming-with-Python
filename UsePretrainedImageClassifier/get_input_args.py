...
def get_input_args():
    ...
    #Argument 1: Image Folder as --dir with default value 'pet_images'
    ...
    # Argument 3:  Text File with Dog Names as --dogfile with default value 'dognames.txt'
